  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md p-8">
        <div className="login-card bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 shadow-lg p-8">
          <div className="flex items-center justify-center mb-8">
            ...
            <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">TECHTREK LOGIN</span>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <input
              ...
              required
              className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                required
                className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 pr-12 placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <span
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 py-3 rounded-lg text-white font-medium transition duration-300"
            >
              Log In
            </button>
          </form>
