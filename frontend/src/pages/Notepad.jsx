...
export default function Notepad() {
  ...
  const fetchNotes = async () => {
    ...
    try {
      ...
      if (Array.isArray(res.data) && res.data.length === 0) {
        console.log(
          "API returned an empty array, no notes found for this user."
        );
      } else if (!Array.isArray(res.data)) {
        console.log(
          "Warning: API did not return an array as expected:",
          typeof res.data
        );
      }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`${API_URL}${id}`); // Only note ID needed
  ...
  const handleEdit = (id) => {
    ...
    if (noteToEdit) {
      ...
      setCurrentNoteId(id);
      console.log("Updated Current Note ID:", id); 
    }
  };
  ...
  return (
    <div
      className={`flex flex-col h-screen pt-21 max-h-screen ${
    ...
    >
      ...
      <div
        ...
        } border-b px-6 py-4 flex justify-between items-center shadow-sm`}
      >
        ...
        <div className="flex items-center">
          <button
            ...
            } p-2 rounded-full mr-4 hover:opacity-80 transition-opacity`}
          ...
          <button
            ...
            } text-white px-4 py-2 rounded-md mr-2 transition-colors`}
          >
            New Note
          </button>
          <button
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          <div
            ...
            } sticky top-0 border-b border-gray-200 z-10`}
          >
            <div
          ...
          <div className="overflow-y-auto flex-1 px-3 py-2">
            <h3
              className={`text-sm font-medium ${
                darkMode ? "text-gray-400" : "text-gray-500"
              } uppercase tracking-wider mb-3 ml-2`}
            >
            ...
            {filteredNotes.length === 0 ? (
              ...
              filteredNotes.map((note, index) => (
                <div
                  ...
                  } p-3 mb-2 rounded-lg border cursor-pointer group transition-colors`}
                ...
                >
                  ...
                  <div
                    className={`max-h-12 overflow-hidden text-sm mb-2 ${
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div
            ...
            } px-4 py-2 text-sm border-t flex justify-between items-center`}
          >
            <div>
              {notes.trim()
