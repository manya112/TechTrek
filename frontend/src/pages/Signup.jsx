...
export default function VibrantSignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans antialiased relative overflow-hidden flex items-center justify-center py-12">
      ...
      <div className="relative z-10 w-full max-w-md p-8">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-64 h-64 rounded-full bg-blue-600/20 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-80 h-80 rounded-full bg-purple-600/20 blur-3xl"></div>
        
        {/* Signup card */}
        <div className="signup-card bg-black/40 backdrop-blur-lg rounded-2xl border border-white/10 shadow-lg shadow-purple-500/10 p-8 transition-all duration-300">
          {/* Logo & branding */}
          ...
          <p className="text-white/60 text-center mb-6">Start your tech career journey today</p>
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-white/40">person</span>
                  <input 
                    type="text" 
                    id="firstName" 
                    className="w-full bg-white/5 border border-white/10 rounded-lg py-3 pl-10 pr-4 placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200"
                    placeholder="John"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <input 
                  type="text" 
                  id="lastName" 
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200"
                  placeholder="Doe"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  id="password" 
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 pl-10 pr-10 placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200"
                  placeholder="********"
                />
                <button 
                  type="button" 
              ...
              <p className="text-xs text-white/40 mt-1">Must be at least 8 characters with a number and special character</p>
            </div>
            ...
            <div className="flex items-center">
              <input 
                id="terms" 
                type="checkbox" 
                className="h-4 w-4 rounded border-white/20 bg-white/5 focus:ring-purple-500 focus:ring-offset-gray-900"
              />
            ...
            <button 
              type="submit" 
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 py-3 rounded-lg text-white font-medium shadow-lg shadow-purple-600/30 transition-all duration-300 hover:shadow-xl hover:shadow-blue-600/40"
            >
              Create Account
            </button>
          </form>
